        ...
        <div className='flex items-end justify-between gap-2'>
          ...
          <div className='flex-shrink-0'>
            {'variants' in product && product.variants?.nodes?.[0] ? (
              ...
              >
                {fetcher => (
                  <button
                    ...
                    className={`bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-1 px-2 rounded-lg transition-all duration-200 flex items-center gap-1 text-sm group-hover:scale-105 group-hover:shadow-lg cursor-pointer whitespace-nowrap ${
              ...
              <div className='bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-1 px-2 rounded-lg transition-all duration-200 flex items-center gap-1 text-sm group-hover:scale-105 group-hover:shadow-lg whitespace-nowrap'>
